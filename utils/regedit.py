...
from config import PROJ_TEMP_DIR, BASE_DIR, MAIN_FILE_NAME, AUTORUN_NAME, RUN_FILENAME, BAT_FILENAME, PYTHON_VENV_PATH
...
class RegEdit:
    def __init__(self):
        self.autorun_path: str = os.path.join(PROJ_TEMP_DIR, RUN_FILENAME)
        self.bat_file_path: str = os.path.join(PROJ_TEMP_DIR, BAT_FILENAME)
